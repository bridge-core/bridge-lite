(function () {
    ...
    *--------------------------------------------------------------------------------------------*/
    ...
    (function (Hover) {
        ...
        function is(value) {
            ...
            return !!candidate && Is.objectLiteral(candidate) && (MarkupContent.is(candidate.contents) ||
                ...
                Is.typedArray(candidate.contents, MarkedString.is)) && (value.range === void 0 || Range$1.is(value.range));
        }
        Hover.is = is;
    })(Hover || (Hover = {}));
    /**
    ...
    var NullASTNodeImpl = /** @class */ (function (_super) {
        __extends$6(NullASTNodeImpl, _super);
    ...
    var BooleanASTNodeImpl = /** @class */ (function (_super) {
        __extends$6(BooleanASTNodeImpl, _super);
    ...
    var ArrayASTNodeImpl = /** @class */ (function (_super) {
        __extends$6(ArrayASTNodeImpl, _super);
    ...
    var NumberASTNodeImpl = /** @class */ (function (_super) {
        __extends$6(NumberASTNodeImpl, _super);
    ...
    var StringASTNodeImpl = /** @class */ (function (_super) {
        __extends$6(StringASTNodeImpl, _super);
    ...
    var PropertyASTNodeImpl = /** @class */ (function (_super) {
        __extends$6(PropertyASTNodeImpl, _super);
    ...
    var ObjectASTNodeImpl = /** @class */ (function (_super) {
        __extends$6(ObjectASTNodeImpl, _super);
    ...
    function parse$2(textDocument, config) {
        ...
        function _parseArray(parent) {
            ...
            while (scanner.getToken() !== 4 /* CloseBracketToken */ && scanner.getToken() !== 17 /* EOF */) {
                ...
                if (!item) {
                    _error(localize$1('PropertyExpected', 'Value expected'), ErrorCode.ValueExpected, null, [], [4 /* CloseBracketToken */, 5 /* CommaToken */]);
                }
                else {
        ...
        function _parseObject(parent) {
            ...
            while (scanner.getToken() !== 2 /* CloseBraceToken */ && scanner.getToken() !== 17 /* EOF */) {
                ...
                if (!property) {
                    _error(localize$1('PropertyExpected', 'Property expected'), ErrorCode.PropertyExpected, null, [], [2 /* CloseBraceToken */, 5 /* CommaToken */]);
                }
                else {
    ...
    *--------------------------------------------------------------------------------------------*/
    ...
    var JSONCompletion = /** @class */ (function () {
        ...
        JSONCompletion.prototype.getSchemaLessValueCompletions = function (doc, node, offset, document, collector) {
            ...
            var collectSuggestionsForValues = function (value) {
                if (!contains$1(value.parent, offset, true)) {
                    collector.add({
    ...
    if (typeof process === 'object') {
        ...
        isWindows$1 = userAgent.indexOf('Windows') >= 0;
    }
    //#endregion
    var _schemePattern$1 = /^\w[\w\d+.-]*$/;
    var _singleSlashStart$1 = /^\//;
    var _doubleSlashStart$1 = /^\/\//;
    function _validateUri$1(ret, _strict) {
        // scheme, must be set
        if (!ret.scheme && _strict) {
            throw new Error("[UriError]: Scheme is missing: {scheme: \"\", authority: \"" + ret.authority + "\", path: \"" + ret.path + "\", query: \"" + ret.query + "\", fragment: \"" + ret.fragment + "\"}");
        }
        // scheme, https://tools.ietf.org/html/rfc3986#section-3.1
        // ALPHA *( ALPHA / DIGIT / "+" / "-" / "." )
        if (ret.scheme && !_schemePattern$1.test(ret.scheme)) {
            throw new Error('[UriError]: Scheme contains illegal characters.');
        }
        // path, http://tools.ietf.org/html/rfc3986#section-3.3
        // If a URI contains an authority component, then the path component
        ...
        if (ret.path) {
            if (ret.authority) {
                if (!_singleSlashStart$1.test(ret.path)) {
                    throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
                }
            }
            else {
                if (_doubleSlashStart$1.test(ret.path)) {
                    throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")');
                }
            }
        }
    ...
    // back to the file-scheme. that should cause the least carnage and still be a
    // clear warning
    function _schemeFix$1(scheme, _strict) {
        if (!scheme && !_strict) {
            return 'file';
        }
        return scheme;
    ...
    // implements a bit of https://tools.ietf.org/html/rfc3986#section-5
    function _referenceResolution$1(scheme, path) {
        // the slash-character is our 'default base' as we don't
        // support constructing URIs relative to other URIs. This
        // also means that we alter and potentially break paths.
        // see https://tools.ietf.org/html/rfc3986#section-5.1.4
    ...
    var URI$1 = /** @class */ (function () {
        ...
        function URI(schemeOrData, authority, path, query, fragment, _strict) {
            if (_strict === void 0) { _strict = false; }
            if (typeof schemeOrData === 'object') {
                this.scheme = schemeOrData.scheme || _empty$1;
                this.authority = schemeOrData.authority || _empty$1;
                this.path = schemeOrData.path || _empty$1;
                this.query = schemeOrData.query || _empty$1;
                this.fragment = schemeOrData.fragment || _empty$1;
                // no validation because it's this URI
                // that creates uri components.
                // _validateUri(this);
            }
            else {
                this.scheme = _schemeFix$1(schemeOrData, _strict);
                this.authority = authority || _empty$1;
                this.path = _referenceResolution$1(this.scheme, path || _empty$1);
                this.query = query || _empty$1;
                this.fragment = fragment || _empty$1;
                _validateUri$1(this, _strict);
            }
        }
        URI.isUri = function (thing) {
            if (thing instanceof URI) {
        ...
        URI.prototype.with = function (change) {
            ...
            return new _URI$1(scheme, authority, path, query, fragment);
        };
        // ---- parse & validate ------------------------
        /**
         * Creates a new URI from a string, e.g. `http://www.msft.com/some/path`,
        ...
        URI.parse = function (value, _strict) {
            if (_strict === void 0) { _strict = false; }
            var match = _regexp$1.exec(value);
            if (!match) {
                return new _URI$1(_empty$1, _empty$1, _empty$1, _empty$1, _empty$1);
            }
            return new _URI$1(match[2] || _empty$1, decodeURIComponent(match[4] || _empty$1), decodeURIComponent(match[5] || _empty$1), decodeURIComponent(match[7] || _empty$1), decodeURIComponent(match[9] || _empty$1), _strict);
        };
        /**
         * Creates a new URI from a file system path, e.g. `c:\my\files`,
         * `/usr/home`, or `\\server\share\some\path`.
         ...
         */
        URI.file = function (path) {
            var authority = _empty$1;
            // normalize to fwd-slashes on windows,
            // on other systems bwd-slashes are valid
            // filename character, eg /f\oo/ba\r.txt
            if (isWindows$1) {
                path = path.replace(/\\/g, _slash$1);
            }
            // check for authority as used in UNC shares
            // or use the path as given
            if (path[0] === _slash$1 && path[1] === _slash$1) {
                var idx = path.indexOf(_slash$1, 2);
                if (idx === -1) {
                    authority = path.substring(2);
                    path = _slash$1;
                }
                    ...
                    authority = path.substring(2, idx);
                    path = path.substring(idx) || _slash$1;
                }
            }
            return new _URI$1('file', authority, path, _empty$1, _empty$1);
        };
        URI.from = function (components) {
            return new _URI$1(components.scheme, components.authority, components.path, components.query, components.fragment);
        };
        // ---- printing/externalize ---------------------------
        /**
         * Creates a string representation for this URI. It's guaranteed that calling
        ...
        URI.prototype.toString = function (skipEncoding) {
            if (skipEncoding === void 0) { skipEncoding = false; }
            return _asFormatted$1(this, skipEncoding);
        };
        URI.prototype.toJSON = function () {
            return this;
        };
        URI.revive = function (data) {
            if (!data) {
                ...
                var result = new _URI$1(data);
                result._formatted = data.external;
                result._fsPath = data._sep === _pathSepMarker$1 ? data.fsPath : null;
                return result;
            }
        };
        return URI;
    }());
    var _pathSepMarker$1 = isWindows$1 ? 1 : undefined;
    // tslint:disable-next-line:class-name
    var _URI$1 = /** @class */ (function (_super) {
        __extends$7(_URI, _super);
        function _URI() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this._formatted = null;
            _this._fsPath = null;
        ...
        Object.defineProperty(_URI.prototype, "fsPath", {
            get: function () {
                if (!this._fsPath) {
                    this._fsPath = _makeFsPath$1(this);
                }
                return this._fsPath;
            },
            enumerable: true,
        ...
        _URI.prototype.toString = function (skipEncoding) {
            ...
            if (!skipEncoding) {
                if (!this._formatted) {
                    this._formatted = _asFormatted$1(this, false);
                }
                return this._formatted;
            }
            else {
                // we don't cache that
                return _asFormatted$1(this, true);
            }
        };
        _URI.prototype.toJSON = function () {
            var res = {
    ...
    // reserved characters: https://tools.ietf.org/html/rfc3986#section-2.2
    var encodeTable$1 = (_a$1 = {},
        _a$1[58 /* Colon */] = '%3A',
        _a$1[47 /* Slash */] = '%2F',
        _a$1[63 /* QuestionMark */] = '%3F',
        _a$1[35 /* Hash */] = '%23',
        _a$1[91 /* OpenSquareBracket */] = '%5B',
        _a$1[93 /* CloseSquareBracket */] = '%5D',
        _a$1[64 /* AtSign */] = '%40',
        _a$1[33 /* ExclamationMark */] = '%21',
        _a$1[36 /* DollarSign */] = '%24',
        _a$1[38 /* Ampersand */] = '%26',
        _a$1[39 /* SingleQuote */] = '%27',
        _a$1[40 /* OpenParen */] = '%28',
        _a$1[41 /* CloseParen */] = '%29',
        _a$1[42 /* Asterisk */] = '%2A',
        _a$1[43 /* Plus */] = '%2B',
        _a$1[44 /* Comma */] = '%2C',
        _a$1[59 /* Semicolon */] = '%3B',
        _a$1[61 /* Equals */] = '%3D',
        _a$1[32 /* Space */] = '%20',
        _a$1);
    function encodeURIComponentFast$1(uriComponent, allowSlash) {
        var res = undefined;
        var nativeEncodePos = -1;
        for (var pos = 0; pos < uriComponent.length; pos++) {
            var code = uriComponent.charCodeAt(pos);
            ...
            if ((code >= 97 /* a */ && code <= 122 /* z */)
                ...
                // check with default table first
                var escaped = encodeTable$1[code];
                if (escaped !== undefined) {
                    // check if we are delaying native encode
                    if (nativeEncodePos !== -1) {
                        res += encodeURIComponent(uriComponent.substring(nativeEncodePos, pos));
    ...
    function encodeURIComponentMinimal$1(path) {
        var res = undefined;
        for (var pos = 0; pos < path.length; pos++) {
            var code = path.charCodeAt(pos);
            if (code === 35 /* Hash */ || code === 63 /* QuestionMark */) {
     ...
     * Create the external version of a uri
     */
    function _asFormatted$1(uri, skipEncoding) {
        var encoder = !skipEncoding
            ? encodeURIComponentFast$1
            : encodeURIComponentMinimal$1;
        var res = '';
        var scheme = uri.scheme, authority = uri.authority, path = uri.path, query = uri.query, fragment = uri.fragment;
        if (scheme) {
            res += scheme;
        ...
        if (fragment) {
            res += '#';
            res += !skipEncoding ? encodeURIComponentFast$1(fragment, false) : fragment;
        }
        return res;
    }
        ...
        JSONSchemaService.prototype.resolveSchemaContent = function (schemaToResolve, schemaURL, dependencies) {
            ...
            if (schema.$schema) {
                ...
                if (id === 'http://json-schema.org/draft-03/schema') {
                    ...
                    schemaToResolve.errors.push(localize$3('json.schema.draft201909.notsupported', "Draft 2019-09 schemas are not yet fully supported."));
                }
            }
